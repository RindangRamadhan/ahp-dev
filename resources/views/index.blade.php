...
<body id="homepage">
    ...
    <header class="banner get-image" data-image="../assets/img/product/Alpha 16 Super.jpg">
                ...
                <div class="carousel-inner">
                    <div class="item slides active">
                        ...
                        <div class="hero">
                            ...
                            <a href="
                            about-us.html" class="btn btn-hero btn-lg" style="z-index:1000;">Learn
                                More</a>
                        </div>
                    </div>
                    <div class="item slides">
                        ...
                        <div class="hero">
                            ...
                            <a href="product-herbisida.html" class="btn btn-hero btn-lg" style="z-index:1000;">See all
                                product</a>
                        </div>
                    </div>
                    <div class="item slides">
                        ...
                        <div class="hero">
                            ...
                            <a href="product-herbisida.html" class="btn btn-hero btn-lg" style="z-index:1000;">See
                                all
                                Alsintan</a>
        ...
        <a href="#scrolldirect" class="btn-scroll page-scroll hidden-xs"><img src="../assets/img/home/scrolldown.gif"
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-8 col-md-offset-2 col-sm-12 paragraph">
                        <p class="section-desc">PT. Andall Hasa Prima didirikan di Bandar Lampung pada tanggal 23
                            ...
                            pertanian di sejumlah daerah dan kota di Indonesia</p>
                    </div>
                    ...
                    <div class="col-md-12 reset-col">
                        <div class="col-md-6 lparagraph">
                            <div class="col-md-12 reset-col paragraph">
                                <p class="section-desc">Teknik pertanian merupakan pendekatan teknik (engineering)
    ...
    <script src="../assets/libraries/slick/slick.js"></script>
