                            ...
                            <div class="col-md-5 reset-col rcontent">
                                ...
                                <div class="col-md-12 reset-col setup-quote">
                                    ...
                                    <div class="quotes-desc">
                                        <p>" Saya bangga menjadi bagian dari keluarga PT Andall Hasa Prima. Sangat
                                            menghargai kami sebagai pekerja. "</p>
                                    </div>
                                </div>
                                <div class="col-md-12 reset-col people-quote">
                                    <img class="img-responsive img-circle" src="../assets/img/Team/testi.jpg" alt="">
                                    <h5 class="people-name">Mrs. Nama Karyawan</h5>
                                </div>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 content">
                            ...
                            <div class="col-md-7 reset-col paragraph">
                                <p class="content-desc">Andall Hasa Prima services are the sum of years of experiences
                                    and dedication
                                    in the
                                    feild of solutions; not only making solutions sessions possible in your home, but
                                    making it simple and easy!!
                                    <br>
                                    <br> Talk one-on-one with a our staff through video or audio chats. our our staff
                                    will provide you with actionable recommendations to help you and your harvest. If
                                    you
                                    prefer to talk to counsel a our staff via email, look no further. we will reply
                                    within 24 hours to answer all your questions. Weekly video exercises tailored to
                                    your harvest needs.</p>
                            </div>
                            <div class="col-md-12 reset-col">
