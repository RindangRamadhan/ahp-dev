                    ...
                    <div class="banner-box">
                        ...
                        <div class="col-md-12">
                            <div class="banner-title">
                                <h2 class="wow fadeIn" data-wow-delay=".4">Herbisida (Pembasmi Gulma)</h2>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12 wrap-gallery">
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Alat Tanam Benih.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Modern Technology</div>
                                        <h1 class="title">Nama Produk</h1>
                                        <h2 class="sub_title">
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Sprayer Alpha 16.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Timber.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                                        <h2 class="sub_title">
                                            ...
                                            blanditiis debitis quod officiis ad amet recusandae
                                            iusto excepturi eaque, hic cum ullam quae!
                                        </h2><button class="btn btn-info">Read More</button>
                                    </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Viaron.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">New Formula</div>
                                        <h1 class="title">Nama Produk</h1>
                                        <h2 class="sub_title">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                            Enim vitae cumque vero quis aliquid, iure facilis,
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Mesin Tajuk.png" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Ziphos.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">New Formula</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Noweed.png" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Pupuk Urea 2.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Hypotext.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Genitop.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Cilamaya Muncul.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                        ...
                        <div class="col-md-3 col-sm-6 pl-loop">
                            <a href="product-detail.html">
                                <div class="post-module">
                                    <div class="thumbnail">
                                        <img src="../assets/img/new-product/Black Hawk.jpg" class="img-responsive" />
                                    </div>
                                    <div class="post-content">
                                        <div class="category">Best Seller</div>
                                        <h1 class="title">Nama Produk</h1>
                            ...
                            <li>
                                <nav class="text-center">
                                    <ul class="pagination" role="navigation">
                                        <li role="presentation"><a role="button" href="#" aria-label="Previous"><i
                                                    class="fa fa-chevron-left" aria-hidden="true"></i><span class="sr-only">previous</span></a></li>
                                        ...
                                        <li role="presentation"><a role="button" href="#" aria-label="Page #{i}">...</a></li>
                                        <li role="presentation"><a role="button" href="#" aria-label="Next"><i class="fa fa-chevron-right"
